...
from .form import PasswordChangingForm, ProfilePageForm
...
class CreateProfilePageView(CreateView):
	...
	# fields = '__all__'
	# kada sacuvamo formu sacuva se pod korektnog usera
...
class ShowProfilePageView(DetailView):
	...
	def get_context_data(self, *args, **kwargs):
		# users = Profile.objects.all() ovde dobavljamo sve, a to nam ne treba
